...
//  CAN_InitStructure.CAN_Prescaler =6;
  ...
  CAN_InitStructure.CAN_Prescaler =4;
	...
	CAN_FilterInitStructure.CAN_FilterIdLow = (uint16_t)(Set_ID << 3) | CAN_RTR_DATA | CAN_ID_EXT;
	...
	CAN_FilterInitStructure.CAN_FilterMaskIdHigh = 0x0000;//0xffc0;//接受固定标准ID，允许最后一位有不同
	CAN_FilterInitStructure.CAN_FilterMaskIdLow = 0x0000;//0x0005;	//标准数据/远程帧
