...
//V1.1 20120904
//1,增加TIM5_PWM_Init函数。
//2,增加LED0_PWM_VAL宏定义，控制TIM5_CH2脉宽									  
//////////////////////////////////////////////////////////////////////////////////  
...
void TIM3_Int_Init(u16 arr,u16 psc)
{
  TIM_TimeBaseInitTypeDef  TIM_TimeBaseStructure;
	...
	TIM_ITConfig(TIM3,TIM_IT_Update,ENABLE ); //使能指定的TIM5中断,允许更新中断
...
{  
	...
	//GPIO_PinRemapConfig(GPIO_PartialRemap_TIM5, ENABLE); //Timer3部分重映射  TIM5_CH2->PB5    
